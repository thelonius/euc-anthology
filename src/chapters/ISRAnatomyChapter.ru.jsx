  ...
  return (
    <ChapterLayout eyebrow="Глава V" title="Цикл" subtitle="Что происходит за одно срабатывание FOC-ISR на частоте 20 кГц">
      ...
      <Section title="F405 vs F103: цена FPU">
        <Prose>
          Разница между двумя чипами — это не только тактовая частота. F405 имеет аппаратный FPU, который выполняет <InlineCode>VMUL.F32</InlineCode>, <InlineCode>VADD.F32</InlineCode> и другие операции за 1 такт. F103 не имеет FPU: любая операция с float разворачивается компилятором в вызов программной библиотеки (<InlineCode>__aeabi_fmul</InlineCode>, <InlineCode>__aeabi_fadd</InlineCode>), и каждая такая операция занимает 60-100+ тактов.
        </Prose>
        <Prose>
